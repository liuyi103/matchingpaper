...
Research on matching markets dates back to 1970s~\cite{keylist}, which afterwards has many applications, such as stable marriage problems, stable roommate problems, kidney exchange etc.
...
Further, we compare our algorithm with some other algorithms, showing that the importance of the optimal solution.
